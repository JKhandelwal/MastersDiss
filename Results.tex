...
\begin{figure}[H]
	...
	\subfloat[3D PCA k=2]{  \includegraphics[width=0.45\textwidth]{images/kmeans_3d_pca_k=2.png}\label{fig:pca3k2}}\\
	\subfloat[2D T-SNE k=2]{  \includegraphics[width=0.45\textwidth]{images/kmeans_2d_tsne_k=2.png}\label{fig:ts2k2}}
